...
//function for (+/-) break/session buttons
...
var x = function(length,type){
	...
	var y = setInterval(function(){
		//disable (+/-) buttons when timer runs
		isRendering = true;
		//disable rendering of new session/length values when timer runs
		timerRunning = true;
		...
		pauseBtn.addEventListener("click",function(){
			//Enable (+/-) buttons but keep rendering new values disabled
			isRendering = false;
			timerRunning = true;
			clearInterval(y);
		});
